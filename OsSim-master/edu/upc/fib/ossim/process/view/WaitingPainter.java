...
public class WaitingPainter extends TablePainterTemplate { 
	 ...
	 * 
	 */
	public WaitingPainter(Presenter presenter, String title, String keyHelp, Vector<Object> header, int width, int height) { 
