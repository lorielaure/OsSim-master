...
public class Process implements Comparable<Process>, Cloneable { 
	 ...
	 */
	public Process(int pid, String name, int prio, int timesubmission, boolean periodic, Vector<Integer> burstsCycle, Color color, Vector<Integer> variables, Vector<Integer> resources) {
		this.pid = pid;
		this.name = name;
		this.prio = prio;
...
//->
		...
		attribute.add(svariables);
		data.add(attribute);
		attribute = new Vector<String>();
		attribute.add("resources");
		attribute.add(sresources);
		data.add(attribute);
...
//-> modification ici en suivant le plan
	...
	public Vector<Integer> getResources() {
		// TODO Auto-generated method stub
